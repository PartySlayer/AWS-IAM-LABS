...
| 🟡 | **03** | [**Secrets**](./labs/03-keep-it-secret) | AWS Secrets Manager, data block "random" per generazione password | ✅ Completato |
| 🔴 | **04** | [**Network Isolation**](./labs/04-network-isolation) |  VPC Endpoints & Bucket Policies | ✅ Completato| |

## 🛠️ Tech Stack Globale

* **Cloud Provider & Core Tech:** AWS, AWS CLI, Terraform
* **Security:** GPG/PGP, IAM Policy Simulator, RBAC, Roles vs Users, Secrets management, VPC Endpoints, Bucket Policies
